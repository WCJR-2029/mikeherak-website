      ...
      <section className="section-padding bg-gradient-to-b from-slate-100 to-slate-50">
        <div className="container-narrow">
          <div className="max-w-3xl">
            <p className="text-azure-600 font-medium text-lg mb-4 animate-fade-in">
              Organizational Intelligence Libraries
            </p>
            <h1 className="text-balance mb-6 animate-slide-up">
              Your AI tools give generic answers because they don&apos;t understand{' '}
              <span className="text-navy-700">your methodology</span>
            </h1>
            <p className="text-body-lg text-slate-600 mb-8 max-w-2xl animate-slide-up animate-delay-100">
        ...
        <div className="container-narrow">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card">
              ...
              <h4 className="mb-3">Generic AI Outputs</h4>
            ...
            <div className="card">
              ...
              <h4 className="mb-3">Key Person Risk</h4>
              <p className="text-slate-600">
            ...
            <div className="card">
              ...
              <h4 className="mb-3">No Defensible Moat</h4>
              <p className="text-slate-600">
      ...
      <section className="section-padding bg-slate-50">
        <div className="container-narrow">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white border-2 border-navy-200 rounded-sm p-8 md:p-10">
            ...
            {/* AI Optimization */}
            <div className="bg-white border-2 border-azure-200 rounded-sm p-8 md:p-10">
            ...
            {blogPosts.map((post) => (
              <article key={post.slug} className="group">
                <Link href={`/blog/${post.slug}`}>
                  <div className="bg-slate-100 aspect-[16/10] rounded-sm mb-5 group-hover:bg-slate-200 transition-colors" />
